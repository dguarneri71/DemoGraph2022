...
import styles from './MicrosoftGraph.module.scss';
import {
  BaseButton,
  Button,
  CheckboxVisibility,
...
import { IMicrosoftGraphProps } from './IMicrosoftGraphProps';
import { IMicrosoftGraphState } from './IMicrosoftGraphState';
...
export default class MicrosoftGraph extends React.Component<IMicrosoftGraphProps, IMicrosoftGraphState> {
  constructor(props: IMicrosoftGraphProps, state: IMicrosoftGraphState) {
    super(props);
  ...
  public render(): React.ReactElement<IMicrosoftGraphProps> {
    return (
      <div className={styles.microsoftGraph}>
